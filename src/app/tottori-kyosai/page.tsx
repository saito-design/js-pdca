...
const PORTAL_URL = process.env.NEXT_PUBLIC_PORTAL_TOTTORI_URL || 'https://portal-tottori.vercel.app'
const COMPANY_ID = 'tottori-kyosai'
const SESSION_KEY = 'auth_tottori_kyosai'
const CLIENT_ID = 'client-mloz4flk-3jld'
...
export default function TottoriKyosaiPage() {
  return (
    <Suspense fallback={
      ...
      <TottoriKyosaiContent />
    </Suspense>
  )
}

function TottoriKyosaiContent() {
